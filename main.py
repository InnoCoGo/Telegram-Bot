...
def handle_tg_update(chat_id, text):
    tg_send_message(chat_id, f"You said: {text}. The last backend endpoint request said {backend_variable}")
...
if __name__ == '__main__':
    load_dotenv()
    app.run(debug=True, host='0.0.0.0', ssl_context=(os.getenv("CERT_FILE"), os.getenv("PKEY_FILE")))
